...
void PrefabComponent::RegisterObject(Context* context)
{
    ...
    URHO3D_ACCESSOR_ATTRIBUTE("PrefabGUID", GetPrefabGUID, SetPrefabGUID, String, String::EMPTY, AM_FILE | AM_NOEDIT);
}
...
void PrefabComponent::LoadPrefabNode()
{
    ...
    auto* xmlfile = cache->GetResource<XMLFile>(prefabGUID_, false);
